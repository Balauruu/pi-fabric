// Temporary evaluator artifact. Delete before merge.
...
const out='/home/balauru/.pi-profiles/fabric/tmp/fabric-research-rework-review/contract-evaluator-final';
...
const compileBodies=blocks.map((body,i)=>i>=4 ? helper+'\n'+body : body);
const result={blockCount:blocks.length,helperPrependedTo:[5,6,7],syntax:[],types:[],schema:null,loader:null};
...
const loaded=loadSkillsFromDir({dir:root,source:'temporary-final-contract-evaluation'});
