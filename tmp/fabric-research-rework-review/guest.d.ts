...
interface FabricExtensionsApiDynamic {
  fetch_content(args?: { answerModel?: string; auth?: string | boolean; forceClone?: boolean; frames?: number; mode?: "readable" | "raw" | "answer"; model?: string; prompt?: string; proxy?: string; timestamp?: string; url?: string; urls?: Array<string>; [key: string]: unknown }): Promise<FabricCapturedToolResult>;
  get_search_content(args: { findMode?: "exact" | "case-insensitive" | "fuzzy"; findText?: string | Array<string>; limit?: number; offset?: number; query?: string; queryIndex?: number; responseId: string; url?: string; urlIndex?: number; [key: string]: unknown }): Promise<FabricCapturedToolResult>;
  source_check(args: { claim: string; domainFilter?: Array<string>; fetchContent?: boolean; numResults?: number; provider?: "auto" | "all" | "openai" | "brave" | "parallel" | "parallel-mcp" | "tinyfish" | "search1api" | "searchinfinity" | "querit" | "tavily" | "firecrawl" | Array<"openai" | "brave" | "parallel" | "parallel-mcp" | "tinyfish" | "search1api" | "searchinfinity" | "querit" | "tavily" | "firecrawl" | "jina" | "searxng">; proxy?: string; queries?: Array<string>; recencyFilter?: "day" | "week" | "month" | "year"; [key: string]: unknown }): Promise<FabricCapturedToolResult>;
  web_search(args?: { domainFilter?: Array<string>; includeContent?: boolean; numResults?: number; provider?: "auto" | "all" | "openai" | "brave" | "parallel" | "parallel-mcp" | "tinyfish" | "search1api" | "searchinfinity" | "querit" | "tavily" | "firecrawl" | Array<"openai" | "brave" | "parallel" | "parallel-mcp" | "tinyfish" | "search1api" | "searchinfinity" | "querit" | "tavily" | "firecrawl" | "jina" | "searxng">; proxy?: string; queries?: Array<string>; query?: string; recencyFilter?: "day" | "week" | "month" | "year"; workflow?: "none" | "summary-review" | "auto-summary"; [key: string]: unknown }): Promise<FabricCapturedToolResult>;
}
