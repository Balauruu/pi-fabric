...
export const evaluationSummary = (e: EvaluationRecord) => ({ attemptId: e.attemptId ?? null, epoch: e.epoch, specId: e.specId, baselineOid: e.snapshots.baseline.oid, candidateOid: e.snapshots.candidate.oid, id: e.id, purpose: e.purpose, state: e.state, definitionId: e.definitionId, baselineSnapshot: e.snapshots.baseline.id, candidateSnapshot: e.snapshots.candidate.id,
