...
export function researchCommand(operation: string, raw: string): CommandRequest {
  if (!Object.hasOwn(COMMAND_ACTIONS, operation)) throw new Error("Unknown Arbor command. Use setup, doctor, start, show, pause, resume, cancel, steer, keep, discard, review, revise-roles, export, apply, undo-apply.");
