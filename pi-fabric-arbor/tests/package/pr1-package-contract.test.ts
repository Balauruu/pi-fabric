...
test("CLI reads existing inputs, rejects every mutation verb, and changes no fixture bytes", async () => {
  ...
  for (const command of ["validate", "continue-partial", "restart-parent", "resumeAttempt", "runResearch", "revise-roles", "reviseRoles", "control", "propose", "dispatch", "collect", "evaluate", "decide", "distill", "undoApply", "setup", "start", "pause", "resume", "cancel", "steer", "keep", "discard", "review", "apply", "undo", "undo-apply", "export", "generate", "serve", "authorize", "certify", "cleanup"]) {
