...
Status: approved architecture revision and implementation plan; not a completed refactor. Current implementation, verification, coverage limits and publication status are authoritative in `pi-fabric-arbor/acceptance-ledger.md`. PR13 deletion is a separate gate.
